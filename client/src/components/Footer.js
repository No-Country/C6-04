...
const Footer = () => {
  return (
    <div className="w-full max-w-full bg-main-blue flex justify-center items-center flex-col">
      <CategoriesContainer />
      <div className="flex flex-col justify-around items-center w-full my-10 lg:flex lg:flex-row">
        ...
        <img src={logoPersons} className="my-10" alt="" />
        <img src={logo} className="self-center my-10 lg:self-end" alt="" />
      </div>
    </div>
  );
};
