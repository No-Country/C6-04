...
const Equipo = () => {
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-x-5 gap-y-8 xl:gap-y-0 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 place-items-center">
        {team.person.map((person) => (
          <>
            <div className="bg-white bg-opacity-60 w-[170px] h-60 rounded-lg">
              <div className="flex flex-col items-center justify-center p-3">
                ...
                <p className="font-medium text-second-blue">{person.rol}</p>
              </div>

              <div className="flex border-t border-main-black divide-x divide-main-black">
                <a
                  href={person.github}
                  className="flex-1 block p-6 text-center text-black transition duration-200 ease-out hover:bg-gray-100 hover:text-gray-500"
                >
                  <svg
